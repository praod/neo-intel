...
export async function updateSession(request: NextRequest) {
  ...
  // middleware and Server Component/Route Handler see different session
  // data!
  ...
  try {
    ...
    // If there's an error with authentication, log it and allow the request to continue
    ...
    // Allow the request to proceed - the page can handle authentication errors
  }
